...
public class SuperDao extends DaoSupport {
	 ...
	 * @throws DaoException
	 */
	public <E> PaginationList<E> selectPage(String statement, PaginationList<E> page) throws DaoException {
		return this.selectPage(statement, null, page);
	}

	/**
	 * 分页查询 (PaginationOrdersList，无实体参数)
	 * 
	 * @param statement
	 * @param pol
	 * @return
	 ...
	 * @throws DaoException
	 */
	public <E> PaginationList<E> selectPage(String statement, Object parameter, PaginationList<E> page)
			throws DaoException {
		try {
			// TODO 动态排序未开发
			List<E> results = this.getSession().selectList(statement, parameter,
					new RowBounds(page.getPagination().getOffset(), page.getPagination().getLimit()));
	...
	/**
	 * 分页查询（PaginationOrdersList，有实体参数）
	 * 
	 * @param statement
	 * @param parameter
	 * @param pol
	 ...
	 * @throws DaoException
	 */
	public <E> PaginationOrdersList<E> selectPage(String statement, Object parameter, PaginationOrdersList<E> page)
			throws DaoException {
		try {
			// TODO 动态排序未开发
			List<E> results = this.getSession().selectList(statement, parameter,
	...
	/**
	 * 分页查询（有参数），输入参数和输出参数可以不一致 返回对象o根据mapper中的resultType决定
	 * 
	 * @author jiangxia
	 * @param statement
	 * @param pol
	 ...
	 * @throws DaoException
	 */
	public <E, O> PaginationOrdersList<O> selectPageCustomer(String statement, Object parameter,
			PaginationOrdersList<E> pol) throws DaoException {
		try {
			// TODO 动态排序未开发
			List<O> results = this.getSession().selectList(statement, parameter,
					new RowBounds(pol.getPagination().getOffset(), pol.getPagination().getLimit()));
			long count = this.selectCount(statement, parameter);
